...
public class Lambda14 {
	...
	//For range(a,b)==>a is inclusive,b is exclusive	
		
	System.out.println();
	IntStream.rangeClosed(0, 10)
	         .forEach(System.out::print);
	//For rangeClosed(a,b)==>a is inclusive,b is inclusive
	System.out.println();
...
//Print first 5 odd integers on the console by using Functional Programming
	...
	System.out.println();
	                   ...
	                   IntStream.iterate(1,t->t+2)
	                            .limit(5)
	                            .forEach(System.out::print);
//For IntStream to update the elements use iterate()	                            
	System.out.println();
...
System.out.println();
//Print the first power of 2 on the console-->2,2*2=4,2*2*2=8,2*2*2*2=16,2*2*2*2*2=32)
...
System.out.println();
//Calculate 5 factorial ->5*4*3*2*1=120
System.out.println(IntStream.rangeClosed(1, 5)
        .reduce(1,(a,b)->a*b));//120

System.out.println();
//Calculate 50 factorial==>50*49*.....2*1=?
